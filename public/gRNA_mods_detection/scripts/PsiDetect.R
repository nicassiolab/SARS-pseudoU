...
#### ========================================== ####
#!/usr/bin/env Rscript
wdir = "/Volumes/scratch/TSSM/cugolini/tools/PsiNanopore-main/"
print(wdir)
...
kmer.summary.df = read.csv( as.character("/Volumes/scratch/TSSM/cugolini/tools/PsiNanopore-main/data/kmer_summary.csv"))
fasta_file <- FaFile("/Volumes/scratch/TSSM/cugolini/tools/PsiNanopore-main/data/edited_nospace.fa")
Direct1.bam.dir = as.character("/Volumes/scratch/TSSM/cugolini/tools/PsiNanopore-main/data/gRNAs_sorted.bam") #"~/Desktop/Github_Material/PSMB2_hela_D1_hg38.bam"
ctrl.bam.dir    = as.character("/Volumes/scratch/TSSM/cugolini/tools/PsiNanopore-main/data/IVT_sorted.bam")#"~/Desktop/Github_Material/PSMB2_hela_IVT1_hg38.bam"
print("------------------------------------")
...
target.chr = as.character("NC_045512v2")

pos1 = as.numeric(10)
pos2 = as.numeric(29903)
...
write.csv(res.df.U, "/Volumes/scratch/TSSM/cugolini/tools/PsiNanopore-main/data/out_pseudo.csv",row.names = F)
