...
$NANOCOMPORE nanocompore sampcomp --file_list1 $WD/$cell_line/$condition_1/alignments_to_assembly/eventalign/collapse/out_eventalign_collapse.tsv --file_list2 $WD/$cell_line/$condition_2/alignments_to_assembly/eventalign/collapse/out_eventalign_collapse.tsv  --label1 $condition_1 --label2 $condition_2 --fasta $NANOCOMP_FA --outpath $WD/$cell_line/nanocompore/alignments_to_assembly/"$condition_1"_vs_"$condition_2"/ --overwrite --downsample_high_coverage 5000 --allow_warnings --min_coverage 30 --logit --nthreads $THREADS --bed $NANOCOMP_BED
