...
#/hpcnfs/scratch/TSSM/cugolini/tools/f5c/f5c-v0.6/f5c_x86_64_linux eventalign --rna --min-mapq 0 -t 20 -r $DATA/fastq_PUS7_C37/WT.fastq -b $WD/PUS7_KD_C37/map_to_genome/WT_sorted.bam --g $GENOME_FA --samples --print-read-names --scale-events | awk '$2<100 || NR==1' | singularity exec -B /hpcnfs/scratch/ /hpcnfs/scratch/TSSM/cugolini/cov/img/nanocompore_8d6a70c.img  NanopolishComp Eventalign_collapse -t 4  -o $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/WT
...
#/hpcnfs/scratch/TSSM/cugolini/tools/f5c/f5c-v0.6/f5c_x86_64_linux eventalign --rna --min-mapq 0 -t 20 -r $DATA/fastq_PUS7_C37/PUS7_KD.fastq -b $WD/PUS7_KD_C37/map_to_genome/PUS7_KD_sorted.bam --g $GENOME_FA --samples --print-read-names --scale-events | awk '$2<100 || NR==1'| singularity exec -B /hpcnfs/scratch/ /hpcnfs/scratch/TSSM/cugolini/cov/img/nanocompore_8d6a70c.img  NanopolishComp Eventalign_collapse -t 4 -o $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/PUS7_KD

####	parse eventalign file to have for each read only ref position 0 to 100
#awk 'BEGIN{OFS="\t"}{if($1 ~ /^#/ || $1 ~ /^ref_pos/ || $1<100 ) print $0}' $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/PUS7_KD/out_eventalign_collapse.tsv > $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/PUS7_KD/out_eventalign_collapse_0to100.tsv
#awk 'BEGIN{OFS="\t"}{if($1 ~ /^#/ || $1 ~ /^ref_pos/ || $1<100 ) print $0}' $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/WT/out_eventalign_collapse.tsv > $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/WT/out_eventalign_collapse_0to100.tsv

#singularity exec -B /hpcnfs/scratch/ $nanocomp104 nanocompore sampcomp --file_list1 $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/WT/out_eventalign_collapse_0to100.tsv --file_list2 $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/PUS7_KD/out_eventalign_collapse0to100.tsv  --label1 WT --label2 PUS7_KD --fasta $GENOME_FA --outpath $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/sampcomp/PUS7_KD_WT/ --overwrite --downsample_high_coverage 5000 --allow_warnings --pvalue_thr 0.01 --min_coverage 30 --logit --nthreads 3
...
mkdir -p  $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/

#/hpcnfs/scratch/TSSM/cugolini/tools/f5c/f5c-v0.6/f5c_x86_64_linux eventalign --rna --min-mapq 0 -t 20 -r $DATA/fastq_PUS7_C37/WT.fastq -b $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/map_to_human_transcriptome/WT_sorted.bam --g $REF_DATA/transcriptome_fasta_primary_assembly.fa --samples --print-read-names --scale-events | singularity exec -B /hpcnfs/scratch/ /hpcnfs/scratch/TSSM/cugolini/cov/img/nanocompore_8d6a70c.img  NanopolishComp Eventalign_collapse -t 3 -o $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/WT
#/hpcnfs/scratch/TSSM/cugolini/tools/f5c/f5c-v0.6/f5c_x86_64_linux eventalign --rna --min-mapq 0 -t 20 -r $DATA/fastq_PUS7_C37/PUS7_KD.fastq -b $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/map_to_human_transcriptome/PUS7_KD_sorted.bam --g $REF_DATA/transcriptome_fasta_primary_assembly.fa --samples --print-read-names --scale-events | singularity exec -B /hpcnfs/scratch/ /hpcnfs/scratch/TSSM/cugolini/cov/img/nanocompore_8d6a70c.img  NanopolishComp Eventalign_collapse -t 3 -o $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/PUS7_KD

#singularity exec -B /hpcnfs/scratch/ $nanocomp104 nanocompore sampcomp --file_list1 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/WT/out_eventalign_collapse.tsv --file_list2 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/PUS7_KD/out_eventalign_collapse.tsv  --label1 WT --label2 PUS7_KD --fasta $REF_DATA/transcriptome_fasta_primary_assembly.fa --outpath /hpcnfs/scratch/temporary/camilla_TL/sampcomp_mincov1000/ --overwrite --downsample_high_coverage 5000 --allow_warnings --pvalue_thr 0.01 --min_coverage 1000 --logit --nthreads 10 --bed $REF_DATA/Homo_sapiens.GRCh38.98.stranded.BED 

#singularity exec -B /hpcnfs/scratch/ $nanocomp104 nanocompore sampcomp --file_list1 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/WT/out_eventalign_collapse.tsv --file_list2 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/PUS7_KD/out_eventalign_collapse.tsv  --label1 WT --label2 PUS7_KD --fasta $REF_DATA/transcriptome_fasta_primary_assembly.fa --outpath /hpcnfs/scratch/temporary/camilla_TL/sampcomp_mincov500/ --overwrite --downsample_high_coverage 5000 --allow_warnings --pvalue_thr 0.01 --min_coverage 500 --logit --nthreads 10 --bed $REF_DATA/Homo_sapiens.GRCh38.98.stranded.BED

#singularity exec -B /hpcnfs/scratch/ $nanocomp104 nanocompore sampcomp --file_list1 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/WT/out_eventalign_collapse.tsv --file_list2 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/PUS7_KD/out_eventalign_collapse.tsv  --label1 WT --label2 PUS7_KD --fasta $REF_DATA/transcriptome_fasta_primary_assembly.fa --outpath $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/sampcomp_mincov200/ --overwrite --downsample_high_coverage 5000 --allow_warnings --pvalue_thr 0.01 --min_coverage 200 --logit --nthreads 10 --bed $REF_DATA/Homo_sapiens.GRCh38.98.stranded.BED

#singularity exec -B /hpcnfs/scratch/ $nanocomp104 nanocompore sampcomp --file_list1 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/WT/out_eventalign_collapse.tsv --file_list2 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/PUS7_KD/out_eventalign_collapse.tsv  --label1 WT --label2 PUS7_KD --fasta $REF_DATA/transcriptome_fasta_primary_assembly.fa --outpath $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/sampcomp_downsamp500/ --overwrite --downsample_high_coverage 500 --allow_warnings --pvalue_thr 0.01 --min_coverage 30 --logit --nthreads 10 --bed $REF_DATA/Homo_sapiens.GRCh38.98.stranded.BED

#singularity exec -B /hpcnfs/scratch/ $nanocomp104 nanocompore sampcomp --file_list1 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/WT/out_eventalign_collapse.tsv --file_list2 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/PUS7_KD/out_eventalign_collapse.tsv  --label1 WT --label2 PUS7_KD --fasta $REF_DATA/transcriptome_fasta_primary_assembly.fa --outpath /hpcnfs/scratch/temporary/camilla_TL/sampcomp_mincov30/ --overwrite --downsample_high_coverage 5000 --allow_warnings --pvalue_thr 0.01 --min_coverage 30 --logit --nthreads 10 --bed $REF_DATA/Homo_sapiens.GRCh38.98.stranded.BED
