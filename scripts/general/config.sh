...
BASEDIR=""
FILES=""								 	                # directory of configuration files used for the analysis
ENVS=""												# path for anaconda environments
IMG="$BASEDIR/img"
MOUNT_DIR=""			                                     	                        # insert directory to mount on singularity images (needs to contain data and working directory)
