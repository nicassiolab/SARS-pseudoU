...
CURRDIR="cov/SARS-CoV-2_pseudoU/scripts"				        # insert script directory
...
all_cell_lines_results <- "/nanocompore/sampcomp/" 				# directory with nanocompore results from all cell lines pulled together
