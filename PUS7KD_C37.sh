...
/hpcnfs/scratch/TSSM/cugolini/tools/f5c/f5c-v0.6/f5c_x86_64_linux eventalign --rna --min-mapq 0 -t 20 -r $DATA/fastq_PUS7_C37/WT.fastq -b $WD/PUS7_KD_C37/map_to_genome/WT_sorted.bam --g $GENOME_FA --samples --print-read-names --scale-events > $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/WT/events.tsv 
singularity exec -B /hpcnfs/scratch/ /hpcnfs/scratch/TSSM/cugolini/cov/img/nanocompore_8d6a70c.img  NanopolishComp Eventalign_collapse -t 20 $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/WT/events.tsv -o $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/WT
...
/hpcnfs/scratch/TSSM/cugolini/tools/f5c/f5c-v0.6/f5c_x86_64_linux eventalign --rna --min-mapq 0 -t 20 -r $DATA/fastq_PUS7_C37/PUS7_KD.fastq -b $WD/PUS7_KD_C37/map_to_genome/PUS7_KD_sorted.bam --g $GENOME_FA --samples --print-read-names --scale-events > $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/PUS7_KD/events.tsv
singularity exec -B /hpcnfs/scratch/ /hpcnfs/scratch/TSSM/cugolini/cov/img/nanocompore_8d6a70c.img  NanopolishComp Eventalign_collapse -t 20 $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/PUS7_KD/events.tsv -o $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/PUS7_KD
