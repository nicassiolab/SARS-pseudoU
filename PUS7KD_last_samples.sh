...
#### IS NANOPOLISH WORKING CORRECTLY WITH GENOMIC ALIGNMENTS ? I RUN IT ON NRCEQ TO TEST

mkdir -p $WD/genomic_alignments/
#singularity exec -B /hpcnfs/scratch/ $singpore samtools sort /hpcnfs/scratch/TSSM/cugolini/cov/analysis/7_samples/map_to_genome/ALIGNMENTS_BACKUP/recap_vero.bam > $WD/genomic_alignments/recap_vero_sorted.bam
#singularity exec -B /hpcnfs/scratch/ $singpore samtools sort /hpcnfs/scratch/TSSM/cugolini/cov/analysis/7_samples/map_to_genome/ALIGNMENTS_BACKUP/recap_caco.bam > $WD/genomic_alignments/recap_caco_sorted.bam
#singularity exec -B /hpcnfs/scratch/ $singpore samtools merge -f $WD/genomic_alignments/nrceq.bam $WD/genomic_alignments/recap_vero_sorted.bam $WD/genomic_alignments/recap_caco_sorted.bam
#singularity exec -B /hpcnfs/scratch/ $singpore samtools view -h -F 2324 -b $WD/genomic_alignments/nrceq.bam > $WD/genomic_alignments/nrceq_filt.bam
#rm $WD/genomic_alignments/recap_vero_sorted.bam
#rm $WD/genomic_alignments/recap_caco_sorted.bam
#rm $WD/genomic_alignments/nrceq.bam

#### the id of recap1=e373b096b7dc2437453a6665773cce8ea6470e3a and recap2=e5160a6e

mkdir -p /hpcnfs/scratch/TSSM/cugolini/cov/data/recap_datasets/fast5_recap1_vero+recap2_caco/fast5_recap_1_and_2
#mv /hpcnfs/scratch/TSSM/cugolini/cov/data/recap_datasets/fast5_recap1_vero+recap2_caco/fast5_recap2_caco/*.fast5 /hpcnfs/scratch/TSSM/cugolini/cov/data/recap_datasets/fast5_recap1_vero+recap2_caco/fast5_recap_1_and_2/
#mv /hpcnfs/scratch/TSSM/cugolini/cov/data/recap_datasets/fast5_recap1_vero+recap2_caco/fast5_recap1_vero/*.fast5 /hpcnfs/scratch/TSSM/cugolini/cov/data/recap_datasets/fast5_recap1_vero+recap2_caco/fast5_recap_1_and_2/

#/hpcnfs/scratch/TSSM/cugolini/tools/f5c/f5c-v0.6/f5c_x86_64_linux index -d /hpcnfs/scratch/TSSM/cugolini/cov/data/recap_datasets/fast5_recap1_vero+recap2_caco/fast5_recap_1_and_2/ /hpcnfs/scratch/TSSM/cugolini/cov/analysis/recappable_assembly/two_datasets/BC97_45mer.fastq
#singularity exec -B /hpcnfs/scratch/ $singpore samtools index $WD/genomic_alignments/nrceq_filt.bam

#/hpcnfs/scratch/TSSM/cugolini/tools/f5c/f5c-v0.6/f5c_x86_64_linux eventalign --rna --min-mapq 0 -t 3 -r /hpcnfs/scratch/TSSM/cugolini/cov/analysis/recappable_assembly/two_datasets/BC97_45mer.fastq -b $WD/genomic_alignments/nrceq_filt.bam --g $GENOME_FA --samples --print-read-names --scale-events | singularity exec -B /hpcnfs/scratch/ /hpcnfs/scratch/TSSM/cugolini/cov/img/nanocompore_8d6a70c.img  NanopolishComp Eventalign_collapse -o $WD/genomic_alignments/NANOCOMPORE/eventalign/NRCeq


### map WT and KD to GENOME
...
/hpcnfs/scratch/TSSM/cugolini/tools/f5c/f5c-v0.6/f5c_x86_64_linux eventalign --rna --min-mapq 0 -t 8 -r $DATA/fastq_PUS7_C37/WT.fastq -b $WD/PUS7_KD_C37/map_to_genome/WT_sorted.bam --g $GENOME_FA --samples --print-read-names --scale-events | singularity exec -B /hpcnfs/scratch/ /hpcnfs/scratch/TSSM/cugolini/cov/img/nanocompore_8d6a70c.img  NanopolishComp Eventalign_collapse -o $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/WT

singularity exec -B /hpcnfs/scratch/ $singpore minimap2 -k 8 -w 1 -ax splice -g 30000 -G 30000 -A1 -B2 -O2,24 -E1,0 -C0 -z 400,200 --no-end-flt -F 40000 -N 32 --splice-flank=no --max-chain-skip=40 -un -p 0.7 -t 8 $GENOME_FA $DATA/fastq_PUS7_C37/PUS7_KD.fastq > $WD/PUS7_KD_C37/map_to_genome/PUS7_KD.sam
...
/hpcnfs/scratch/TSSM/cugolini/tools/f5c/f5c-v0.6/f5c_x86_64_linux eventalign --rna --min-mapq 0 -t 8 -r $DATA/fastq_PUS7_C37/PUS7_KD.fastq -b $WD/PUS7_KD_C37/map_to_genome/PUS7_KD_sorted.bam --g $GENOME_FA --samples --print-read-names --scale-events | singularity exec -B /hpcnfs/scratch/ /hpcnfs/scratch/TSSM/cugolini/cov/img/nanocompore_8d6a70c.img  NanopolishComp Eventalign_collapse -o $WD/PUS7_KD_C37/map_to_genome/NANOCOMPORE/eventalign/PUS7_KD
