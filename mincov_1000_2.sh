...
singularity exec -B /hpcnfs/scratch/ $nanocomp104 nanocompore sampcomp --file_list1 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/WT/out_eventalign_collapse.tsv --file_list2 $WD/PUS7_KD_C37/map_to_human_transcriptome/NANOCOMPORE/eventalign/PUS7_KD/out_eventalign_collapse.tsv  --label1 WT --label2 PUS7_KD --fasta $REF_DATA/transcriptome_fasta_primary_assembly.fa --outpath /hpcnfs/scratch/temporary/camilla_TL/sampcomp_mincov50/ --overwrite --downsample_high_coverage 5000 --allow_warnings --pvalue_thr 0.01 --min_coverage 50 --logit --nthreads 10 --bed $REF_DATA/Homo_sapiens.GRCh38.98.stranded.BED
